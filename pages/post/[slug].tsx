       ...
       <hr className = "max-w-lg my-5 mx-auto border border-yellow-500" />
        ...
        {submitted ? (
            <div className="flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto">
                ...
                <p>
                    Once it has been approved, it will apppear below!
                </p>
            </div>
        ): 
        (
            ...
            <label className="block mb-5">
                ...
                className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline:none focus:ring" placeholder="Name" type = "text" /> 
             </label>
             <label className="block mb-5">
                <span className="text-gray-700">Email</span>
                <input 
                {...register("email", {required:true})}
                className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline:none focus:ring" placeholder="Email" type= "email"/> 
             </label>
             <label className="block mb-5">
             ...
             hover:bg-yellow-400
              ...
              font-bold
               px-4 py-2 
               rounded cursor-pointer"  type="submit" />
        </form>  
        )}
...
export const getStaticProps: GetStaticProps =  async ({params}) => {
        ...
        return {
            ...
            revalidate: 15, // after 60 seconds the old cached version
        };
};